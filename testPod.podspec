...
Pod::Spec.new do |s|
  ...
  s.author             = { "niuxianbin" => "niuxianbin@126.com" }
  # Or just: s.author    = "niuxianbin"
  # s.authors            = { "niuxianbin" => "niuxianbin@126.com" }
  # s.social_media_url   = "http://twitter.com/niuxianbin"
